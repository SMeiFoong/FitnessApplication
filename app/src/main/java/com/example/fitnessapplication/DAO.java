...
public class DAO {
    ...
    private ArrayList<com.example.fitnessapplication.Task> list = null;
    ...
    private void load(){
        list = new ArrayList<com.example.fitnessapplication.Task>(); // creating empty list
        nextId = 1;
        try
        {
            ...
            {
                com.example.fitnessapplication.Task task = new com.example.fitnessapplication.Task();
    ...
    public com.example.fitnessapplication.Task get(int position)
    {
    ...
    public static String formatTime(com.example.fitnessapplication.Task Task)
    {
        return timeFormat.format(new Date(Task.getDate()));
    }

    public static String formatDate(com.example.fitnessapplication.Task Task)
    {

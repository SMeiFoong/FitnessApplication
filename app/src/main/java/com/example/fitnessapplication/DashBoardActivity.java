...
class TaskListAdapter extends BaseAdapter{
    ...
    private com.example.fitnessapplication.DAO dao; // access to data
    ...
    public TaskListAdapter (Context context)
    {
        ...
        dao = com.example.fitnessapplication.DAO.getInstance(context);
    ...
    {
        ViewHolder holder;
        com.example.fitnessapplication.Task task = dao.get(position);
        ...
        holder.time.setText(com.example.fitnessapplication.DAO.formatTime(task));
        holder.date.setText(com.example.fitnessapplication.DAO.formatDate(task));
    ...
    public com.example.fitnessapplication.Task getItem(int position)
    {
    ...
    public void add(com.example.fitnessapplication.Task Task)
    {
        dao.add(Task);
        update();
    }
    ...
    public void update(com.example.fitnessapplication.Task Task)
    {
        dao.update(Task);
        update();
    }
    ...
    private void setTask(com.example.fitnessapplication.Task task){
        ...
        {
            intent = new Intent(context, com.example.fitnessapplication.TaskReceiver.class);
    ...
    private void cancelTask(com.example.fitnessapplication.Task task){

    }
}


public class DashBoardActivity extends AppCompatActivity implements com.example.fitnessapplication.TasksFragment.OnFragmentInteractionListener{
    ...
    private com.example.fitnessapplication.Task currentTask;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                Class fragmentClass = com.example.fitnessapplication.TasksFragment.class;
                switch(id)
                {
                    case R.id.dashboard:
                        ...
                        break;
                    case R.id.help:
                        fragmentClass = com.example.fitnessapplication.HelpFragment.class;
        ...
        switchFragment(com.example.fitnessapplication.TasksFragment.class);
    ...
    public void onFragmentInteraction(int position){
        Intent intent = new Intent(getBaseContext(), com.example.fitnessapplication.EditActivity.class);
    ...
    public void onAddClick(View view)
    {
        ...
        currentTask = new com.example.fitnessapplication.Task();
        currentTask.toIntent(intent);

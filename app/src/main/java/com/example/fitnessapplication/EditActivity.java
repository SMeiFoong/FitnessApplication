...
public class EditActivity extends AppCompatActivity {
    ...
    private com.example.fitnessapplication.Task task;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        task = new com.example.fitnessapplication.Task();
    ...
    {
        dateButton.setText(com.example.fitnessapplication.DAO.formatDate(task));
        Log.d(TAG, "updated date button");
        timeButton.setText(com.example.fitnessapplication.DAO.formatTime(task));

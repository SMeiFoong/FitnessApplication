...
class TaskListAdapter extends BaseAdapter{
    ...
    private com.example.fitnessapplication.Reminder.DAO dao; // access to data
    ...
    public TaskListAdapter (Context context)
    {
        ...
        dao = com.example.fitnessapplication.Reminder.DAO.getInstance(context);
    ...
    {
        ViewHolder holder;
        com.example.fitnessapplication.Reminder.Task task = dao.get(position);
        ...
        holder.time.setText(com.example.fitnessapplication.Reminder.DAO.formatTime(task));
        holder.date.setText(com.example.fitnessapplication.Reminder.DAO.formatDate(task));
    ...
    public com.example.fitnessapplication.Reminder.Task getItem(int position)
    {
    ...
    private void setTask(com.example.fitnessapplication.Reminder.Task task){
        ...
        {
            intent = new Intent(context, com.example.fitnessapplication.Reminder.TaskReceiver.class);
    ...
    private void cancelTask(com.example.fitnessapplication.Reminder.Task task){

    }
}


public class DashBoardActivity extends AppCompatActivity implements com.example.fitnessapplication.Reminder.TasksFragment.OnFragmentInteractionListener{
    ...
    private com.example.fitnessapplication.Reminder.Task currentTask;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                Class fragmentClass = com.example.fitnessapplication.Reminder.TasksFragment.class;
                switch(id)
                {
                    case R.id.home:
                        ...
                        break;
                    case R.id.logout:
                        fragmentClass = com.example.fitnessapplication.Reminder.HelpFragment.class;
        ...
        switchFragment(com.example.fitnessapplication.Reminder.TasksFragment.class);
    ...
    public void onFragmentInteraction(int position){
        Intent intent = new Intent(getBaseContext(), com.example.fitnessapplication.Reminder.EditActivity.class);
    ...
    public void onAddClick(View view)
    {
        ...
        currentTask = new com.example.fitnessapplication.Reminder.Task();
        currentTask.toIntent(intent);
